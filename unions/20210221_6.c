...
int main(){
    ...
    printf("\ntime wanted after adding hour: %d:%d:%d",wanted.hour, wanted.min, wanted.sec);
    struct time wanted2 = addmin(now,10);
    printf("\ntime wanted after adding minutes: %d:%d:%d",wanted2.hour, wanted2.min, wanted2.sec);
    struct time wanted3 = addsec(now,20);
    printf("\ntime wanted after adding seconds: %d:%d:%d",wanted3.hour, wanted3.min, wanted3.sec);
